...
class TLTodoCard: UIView {
    ...
    convenience init(title todoTitle: String, description todoDescription: String, colour palette: TLColours.TodoPalette = .green) {
...
#if DEBUG
#Preview {
    let card = TLTodoCard(title: "Glopi orders", description: "Make 15 Glopi orders in 15 days")
